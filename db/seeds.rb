...
f=Activity.new(name:"Kew Gardens", description:"Kew Gardens is a botanical garden in southwest London that houses the largest and most diverse botanical and mycological collections in the world. Founded in 1840, from the exotic garden at Kew Park in Middlesex, England, its living collections include more than 30,000 different kinds of plants, while the herbarium, which is one of the largest in the world, has over seven million preserved plant specimens. The library contains more than 750,000 volumes, and the illustrations collection contains more than 175,000 prints and drawings of plants. It is one of London's top tourist attractions and is a World Heritage Site. Kew Gardens, together with the botanic gardens at Wakehurst Place in Sussex, are managed by the Royal Botanic Gardens, Kew (brand name Kew), an internationally important botanical research and education institution that employs 750 staff and is a non-departmental public body sponsored by the Department for Environment, Food and Rural Affairs.")
